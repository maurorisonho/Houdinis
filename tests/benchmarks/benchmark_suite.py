...
class BenchmarkSuite:
    ...
    def benchmark_quantum_operations(self):
        ...
        print(f"[BENCHMARK]   Circuit creation: {result.avg_time_per_iteration*1000:.2f}ms")
        ...
        result.category = 'quantum_ops'
        print(f"[BENCHMARK]   Hadamard gates (4): {result.avg_time_per_iteration*1000:.2f}ms")
        ...
        result.category = 'quantum_ops'
        print(f"[BENCHMARK]   Circuit measurement: {result.avg_time_per_iteration*1000:.2f}ms")
    ...
    def benchmark_shor_algorithm(self):
        ...
        for N, description in test_cases:
            ...
            print(f"[BENCHMARK]   {description}: {result.avg_time_per_iteration*1000:.2f}ms")
    ...
    def benchmark_pqc_attacks(self):
        ...
        print(f"[BENCHMARK]     Timing attack (100 samples): {result.avg_time_per_iteration:.2f}s")
        ...
        result.category = 'pqc_kyber'
        print(f"[BENCHMARK]     CCA attack (50 queries): {result.avg_time_per_iteration:.2f}s")
        ...
        print(f"[BENCHMARK]     Forgery attack (50 attempts): {result.avg_time_per_iteration:.2f}s")
    ...
    def generate_report(self) -> str:
        ...
        for category, results in sorted(categories.items()):
            ...
            for result in results:
                ...
                report.append(f"    Range: {result.min_time*1000:.2f}ms - {result.max_time*1000:.2f}ms")
