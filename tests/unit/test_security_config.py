...
class TestDangerousPatterns:
    ...
    def test_path_traversal_patterns(self):
        ...
        for path in dangerous_paths:
            has_dangerous = any(
                pattern.search(path) for pattern in SecurityConfig.DANGEROUS_PATTERNS
            )
    ...
    def test_code_execution_patterns(self):
        ...
        for code in dangerous_code:
            has_dangerous = any(
                pattern.search(code) for pattern in SecurityConfig.DANGEROUS_PATTERNS
            )
