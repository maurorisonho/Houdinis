...
class TestSessionManager:
    ...
    def test_create_session(self, manager):
        ...
        session = manager.create_session(
            session_type="quantum_exploit", target="192.168.1.100", data=data
        )
...
class TestSessionLifecycle:
    ...
    def test_session_creation_to_deletion(self, manager):
        ...
        # Create
        session = manager.create_session(
            "quantum_exploit", "192.168.1.1", {"factored_key": "RSA-2048"}
        )
...
class TestSessionTypes:
    ...
    def test_quantum_exploit_session(self, manager):
        ...
        session = manager.create_session(
            "quantum_exploit",
            "192.168.1.1",
            {"algorithm": "shor", "qubits": 15, "result": "factored_n=15_factors=3x5"},
        )
    ...
    def test_shell_session(self, manager):
        ...
        session = manager.create_session(
            "shell",
            "10.0.0.5:22",
            {"protocol": "SSH", "username": "root", "method": "quantum_key_recovery"},
        )
