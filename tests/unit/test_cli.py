"""
Houdinis Framework - Unit Tests for CLI Module
...
class TestHoudinisConsole:
    ...
    @patch('builtins.open', create=True)
    def test_execute_resource_script_validates_filename(self, mock_open, mock_exists, console):
    ...
    @patch('pathlib.Path.exists')
    @patch('builtins.open', create=True)
    def test_execute_resource_script_skips_comments(self, mock_open, mock_exists, console):
    ...
    @patch('pathlib.Path.exists')
    @patch('builtins.open', create=True)
    def test_execute_resource_script_enforces_length_limit(self, mock_open, mock_exists, console):
